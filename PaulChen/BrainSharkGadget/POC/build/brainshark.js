            ...
            React.createElement("div", null, 
              React.createElement("table", {style: {width: "100%"}}, 
                React.createElement("tr", {style: {height: "50px"}}, 
                  React.createElement("td", {style: {width: "50px"}, className: "label-col"}, React.createElement("label", {className: "col-sm-1"}, "URL")), 
                  React.createElement("td", null, React.createElement(Input, {type: "text", className: "form-control", name: "settings-url", placeholder: "https://www.brainshark.com/...", value: this.state.tempUrl, onChange: this.tempUrlChanged, bsStyle: this.validationState(), help: this.state.urlInvalidHint}))
                ), 
                React.createElement("tr", {style: {height: "50px"}}, 
                  React.createElement("td", {style: {width: "50px"}, className: "label-col"}, React.createElement("label", {className: "col-sm-1"}, "Scale")), 
