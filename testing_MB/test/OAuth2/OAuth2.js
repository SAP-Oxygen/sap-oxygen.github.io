...
function fetchData() {
  ...
  url = "https://developer.sapjam.com/api/v1/OData/Groups?$format=json";
  ...
  params[gadgets.io.RequestParameters.OAUTH_SERVICE_NAME] = "OAuth2HCP";
...
function oDataProcessing(response) {
  ...
  showStep('step_01_seekApproval');
    ...
    document.getElementById('name').innerHTML = response.data.d.results.Name;
