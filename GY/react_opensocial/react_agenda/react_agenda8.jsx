      ...
      return (
        <li 
          ...
          <div className="div-table-cell edit-col">
            ...
            <span className="glyphicon glyphicon-trash delete-glyphicon" aria-hidden="true" onClick={this.handleDelete}></span>
          </div>
        </li>
      );
    }
      ...
      return (
        <li className="table-button">
          ...
          <div className="div-table-cell presenter-col button-col">
            <button type="button" className="btn btn-default btn-normal" onClick={this.handleAdd}>
