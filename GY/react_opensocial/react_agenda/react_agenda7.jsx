    ...
    render: function() {
      ...
      return (
        <li 
          ...
          <div className="div-table-cell duration-col">{this.props.item.time} min</div>
          <div className="div-table-cell main-col">
            <div className="topic-cell">{topic}</div>
            <div className="desc-cell">{this.props.item.desc}</div>
          </div>
          <div className="div-table-cell presenter-col">{ownerName}</div>
          <div className="div-table-cell trash-col"> - </div>
        </li>
      );
    }
